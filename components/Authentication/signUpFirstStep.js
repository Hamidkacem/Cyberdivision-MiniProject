        ...
        <View>
          ...
          <View className="py-8">
            <View className="bg-[#04AF2F] color-white p-3 items-center justify-center rounded-full py-4 ">
              <Text
                ...
                onPress={() => {
                  navigation.push("SignUpSecondStep", {
                    state: { data: data },
                  });
                }}
              >
          ...
          <View className="flex flex-row justify-center ">
            <Text className="text-[#858585] justify-between text-lg">
              ...
              <Text className="text-[#04AF2F] font-bold" onPress={() => {}}>
                Login
              </Text>
            </Text>
          </View>
          <View className="flex flex-wrap justify-center items-center">
            <Text className="text-[#858585] text-l">
              Signup to Petnet means you agree to our <Text className="text-[#04AF2F]  text-lg font-bold"> privacy </Text>
            </Text>
